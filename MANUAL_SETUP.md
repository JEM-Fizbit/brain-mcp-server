...
2. Call brain_load_context (returns loader navigation table + current priorities + nudges for overdue lint, a stale capture queue, open maintenance issues, or pending inbox files)
