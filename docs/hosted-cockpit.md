...
- the full dashboard context lives inside the Overview tab; Activity, Latency, Checks, and Raw Output start directly with their focused content and only show a compact context strip for Brain, status, action queue, sync, and doctor recency;
