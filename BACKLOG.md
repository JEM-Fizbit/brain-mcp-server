...
- Develop a fuller hosted Brain observability model: representative latency/reliability measures for every MCP tool, real-world organic end-to-end usage sampling, dashboard rollups, and a possible SLO/alerting layer once baseline distributions are known.
