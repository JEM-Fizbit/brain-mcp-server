...
- CloudStorage sync helper app: generated by `npm run sync:helper:install`.
- CloudStorage sync helper auto-start plist: generated by `npm run sync:helper:launchd:plist`.
- Brain Sync menu-bar operator app: generated by `npm run sync:menubar:install`.
- Brain Sync menu-bar auto-start plist: generated by `npm run sync:menubar:launchd:plist`.
